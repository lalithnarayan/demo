  ...
  setupTemplate() {
    ...
    this.typeSelector = new SelectorCtrl([
      ...
      },
      {
        ...
        label: 'Challenge',
        description: 'This is it Peeks, 10 attempts and you win what is rightfully yours!'
      },
      {
