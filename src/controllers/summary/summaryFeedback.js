const SUCCESS_QUOTES_LIST = [
	{ min:   1, max:   3, text: 'That was pure luck, nothing else. Stop dreaming bee.'},
	{ min:   2, max:   4, text: 'You got lucky, without staying up all night.'},
	{ min:   1, max:   2, text: 'No merit. Absolutely none.'},
	{ min:   2, max:   5, text: 'That was given on a silver spoon.'},
...
const FAIL_QUOTES_LIST = [
	'I believe there\'s some work to do Peeks.',
